...
@Service
public class EmpleadoDAOImpl extends PersonaDAOImpl implements EmpeladoDAO {

    @Autowired
    public EmpleadoDAOImpl(@Qualifier("repositoryEmpleado") PersonaReposity repository) {
        super(repository);
    }
